...
- **CTDL xâu**: dùng cho các bài tập [Xử lý xâu](../string/basic.md).
...
- BFS 01
- [Tìm Min/Max trên đoạn tịnh tiến](deque-min-max.md).
...
Sparse Table là cấu trúc dữ liệu được sử dụng trong [bài toán LCA & RMQ](../../translate/topcoder/Range-Minimum-Query-and-Lowest-Common-Ancestor.md).
...
Bạn có thể đọc thêm về Segment Tree [ở đây](segment-tree-extend.md).

Segment Tree cũng có một mở rộng với nhiều ứng dụng quan trọng là [Segment Tree trên tập đoạn thẳng](interval-tree-tap-doan-thang.md).
...
Bạn có thể đọc thêm về Fenwick Tree [ở đây](fenwick.md).
...
Bạn có thể đọc thêm ở: [Thuật toán phân tách cây](heavy-light-decomposition.md)
...
Bạn có thể đọc thêm [bài viết về trie](trie.md).
...
Như tên gọi của nó, Palindrome tree là một CTDL giúp giải quyết các bài toán về Palindrome. Bạn có thể đọc thêm [ở đây](../../translate/codeforces/palindrome-tree.md)
