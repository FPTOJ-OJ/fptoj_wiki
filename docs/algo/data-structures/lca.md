...
Trước khi đọc bài viết này, bạn cần đọc bài viết: [Bài toán RMQ và bài toán LCA](../../translate/topcoder/Range-Minimum-Query-and-Lowest-Common-Ancestor.md) để nắm được những khái niệm cơ bản.
