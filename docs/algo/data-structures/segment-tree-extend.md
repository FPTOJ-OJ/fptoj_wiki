...
- Segment Tree còn có [một cách cài đặt khác sử dụng ít bộ nhớ hơn](../../translate/codeforces/Efficient-and-easy-segment-trees.md) (tối đa $2*N$ phần tử), cài đặt ngắn hơn và chạy nhanh hơn. Tuy nhiên theo cá nhân mình không dễ hiểu bằng cách cài đặt trong bài viết này.
...
=== "C++"
    ...
    Ta có thể thấy cây phân đoạn là một ứng dụng trong mảng, vì lí do đó nếu chúng ta có thể đổi cây thành các mảng, ta có thể dễ dàng xử lý các truy vấn trên cây. Đây là tư tưởng của [Heavy Light Decomposition](heavy-light-decomposition.md).
    ...
    **Bài toán**
    ...
    Để giải bài toán này, hai cách phổ biến là ứng dụng [bao lồi](../../translate/wcipeg/Convex-Hull-Trick.md) và sử dụng cây [Interval Tree lưu đoạn thẳng](interval-tree-tap-doan-thang.md)
    ...
    **Nguồn:** [Binary Search on Segment Tree](https://github.com/leduythuccs/leduythuccs.github.io/blob/master/_posts/2020-07-10-Binary-Search-on-Segment-Tree.md)
    ...
    Trước hết, ta cần phải nắm được kiến thức cơ bản về Segment tree và chặt nhị phân. Bạn có thể tìm hiểu thuật toán **chặt nhị phân** ở [đây](../basic/binary-search.md).
