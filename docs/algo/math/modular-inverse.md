...
- [Extended Euclid](../../translate/he/So-hoc-Phan-1-Modulo-gcd.md)
- [Tính a^b % c bằng chia để trị](../../translate/he/Number-Theory-3.md)
- [Phi hàm Euler](../../translate/he/Number-Theory-4.md)

## Extended Euclid

Như đã trình bày trong bài viết [Số học 1](../../translate/he/So-hoc-Phan-1-Modulo-gcd.md), nếu $gcd(a, m) = 1$, ta luôn luôn tìm được 2 số nguyên x và y thoả mãn:
...
Với Phi hàm Euler đã được giải thích ở bài viết [Số học 4](../../translate/he/Number-Theory-4.md).
...
Như vậy, ta có thể dùng thuật toán [Tính a^b % c bằng chia để trị](../../translate/he/Number-Theory-3.md) để tính nghịch đảo modulo với độ phức tạp $O(\log{m})$.
