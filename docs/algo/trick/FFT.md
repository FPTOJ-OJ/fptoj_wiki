...
**Tính chất 1:** Ma trận nghịch đảo $V^{-1}$ được tính theo công thức: $V^{-1}[i,j] = \frac{V[i,j]^{-1}}{n}$ với $i, j = 0, 1,...n-1$ là chỉ số hàng và cột của ma trận.
...
- Nếu $i \neq k:$ $P[i, k] = \sum_{j=0}^{n-1}{w_n^{i-k}}^j = \frac{1 - {w_n^{i-k}}^n}{1-w_n^{i-k}} = 0$
