...
*   Ta tiến hành duyệt các vị trí i, dùng 1 cây [Segment Tree](../data-structures/segment-tree-extend.md) hoặc [Binary Indexed Tree](../data-structures/fenwick.md) để quản lý và đếm:
