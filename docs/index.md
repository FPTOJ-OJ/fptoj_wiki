...
|-----------|------------------|
| **Nhập môn (⭐)** | [Setup môi trường](lessons/setup-moi-truong.md), [Độ phức tạp](lessons/do-phuc-tap-thoi-gian.md), [Sắp xếp](lessons/thuat-toan-sap-xep.md), [Tìm kiếm nhị phân](lessons/tim-kiem-nhi-phan.md), [Phép toán bit](lessons/phep-toan-bit.md), [Đệ quy & Quay lui](lessons/de-quy-va-quay-lui.md) |
| **Kỹ thuật (⭐⭐)** | [Hai con trỏ](lessons/ky-thuat-hai-con-tro.md), [Prefix Sum](lessons/mang-stack-prefix-sum.md), [Lũy thừa nhị phân](lessons/luy-thua-nhi-phan-sang-nguyen-to.md) |
| **Cấu trúc dữ liệu**| [Linked List](lessons/linked-list.md), [Queue](lessons/queue.md), [Hash Table](lessons/hash-table.md), [Deque](lessons/deque-sliding-window.md), [Trie](lessons/trie.md), [Heap](lessons/heap.md), [DSU](lessons/dsu.md), [Segment Tree](lessons/segment-tree.md), [Fenwick Tree](lessons/fenwick-tree.md) |
| **Đồ thị** | [BFS/DFS](lessons/bfs-dfs-do-thi.md), [Dijkstra & MST](lessons/mst-dijkstra-topo-sort.md), [Floyd & Bellman-Ford](lessons/floyd-warshall-bellman-ford.md), [LCA](lessons/lca-binary-lifting.md) |
| **QHĐ & Tham lam** | [Quy hoạch động](lessons/quy-hoach-dong.md), [Tham lam](lessons/greedy.md), [Tìm nhị phân trên đáp án](lessons/binary-search-on-answer.md) |
| **Xử lý xâu** | [KMP](lessons/kmp-tim-xau.md), [Z-algorithm](lessons/hash-xau-z-algorithm.md), [Manacher](lessons/manacher.md), [Suffix Array](lessons/suffix-array.md) |
| **Toán & Số học** | [Euclid & Modulo](lessons/euclid-modular-inverse.md), [Tổ hợp](lessons/to-hop-xac-suat.md), [Số học nâng cao](lessons/so-hoc-nang-cao.md), [Trò chơi](lessons/ly-thuyet-tro-choi.md), [Sàng nâng cao](lessons/sang-nang-cao-ham-uoc.md), [Bao hàm loại trừ](lessons/nguyen-ly-bao-ham-loai-tru.md), [Nhân ma trận](lessons/nhan-ma-tran.md), [NTT](lessons/ntt-nhan-da-thuc.md), [Khử Gauss](lessons/khu-gauss.md) |
| **Hình học** | [Hình học cơ bản](lessons/hinh-hoc-co-ban.md), [Đường thẳng](lessons/phuong-trinh-duong-thang.md), [Đường tròn](lessons/hinh-hoc-duong-tron.md), [Bao lồi](lessons/bao-loi.md), [Định lý Pick](lessons/dinh-ly-pick.md), [Sắp xếp cực](lessons/sap-xep-cuc.md) |
| **Kỹ năng (⭐-⭐⭐)** | [Sinh testcase](lessons/sinh-testcase.md), [Debug](lessons/debug-meo.md), [Chiến thuật](lessons/ky-nang-thi-dau.md), [Tổ chức code](lessons/to-chuc-code.md) |
