...
FPTOJ được xây dựng với mục đích chia sẻ kiến thức Tin học đến với tất cả mọi người, đặc biệt tập trung vào Thuật toán và Lập trình thi đấu (Competitive Programming).
Dự án được duy trì và phát triển bởi **FPTOJ Wiki <Hà Trí Kiên>**. Bạn có thể đọc bài giới thiệu của bọn mình [ở đây](about).
