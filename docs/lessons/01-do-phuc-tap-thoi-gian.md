...
> **Logarit cơ số 2 của N** (viết là $\log_2 N$) = **Số lần bạn phải nhân 2 với chính nó để ra N**.
...
- $f(n) = 3n^2 + 5n + 100$ → $O(n^2)$, vì khi n đủ lớn, $3n^2$ "nuốt chửng" mọi thứ còn lại
