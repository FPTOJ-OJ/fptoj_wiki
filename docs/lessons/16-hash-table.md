...
<p align="center"><img src="/uploads/img/hash-table.svg" alt="Hash Table" style="max-width: 700px;" /><br><em>Minh họa cấu trúc Hash Table</em></p>
...
=== "Python"
    ...
    !!! tip "Hàm enumerate() trong Python"
        `enumerate(a)` trả về **cặp (chỉ số, giá trị)** khi duyệt qua mảng. Thay vì:
        ```python
