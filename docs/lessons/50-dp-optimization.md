...
| 11 | [CSES - Increasing Subsequence](https://cses.fi/problemset/task/1145) | LIS | ★★☆ | LIS optimization context |
| 12 | [VNOJ - AtCoder DP N - Slimes](https://oj.vnoi.info/problem/atcoder_dp_n) | Knuth's | ★★★ | Interval DP + Knuth's |
| 13 | [VNOJ - AtCoder DP W - Intervals](https://oj.vnoi.info/problem/atcoder_dp_w) | Lazy SegTree | ★★★★ | Lazy segment tree optimization |
...
> **Bài tiếp theo:** [Bài 51: Aho-Corasick](51-aho-corasick.md)
