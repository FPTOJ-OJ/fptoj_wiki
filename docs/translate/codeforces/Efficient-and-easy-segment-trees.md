...
<img src="/uploads/GGBmcEP.png" alt="img" style="max-width: 700px; display: block; margin: 0 auto;" />
...
<img src="http://imgur.com/cwKpYH1.png" alt="" style="max-width: 700px; display: block; margin: 0 auto;" />
    ...
    def push_assign(l, r):
        ...
        while s > 0:
            for i in range(l >> s, (r >> s) + 1):
                if d[i] != 0:
                    apply_assign(i << 1, d[i], k)
                    apply_assign((i << 1) | 1, d[i], k)
                    d[i] = 0
            s -= 1
            k >>= 1
    ```
...
=== "Python"
    ...
    def modify_assign(l, r, value):
        ...
        while l < r:
            if l & 1:
                apply_assign(l, value, k)
                l += 1
            if r & 1:
                r -= 1
                apply_assign(r, value, k)
            l >>= 1
            r >>= 1
            k <<= 1
        build_assign(l0, l0 + 1)
        build_assign(r0 - 1, r0)
...
=== "Python"
    ...
    ```python
    def modify_optimized(l, r, value):
        if value == 0:
            return
        push_assign(l, l + 1)
        push_assign(r - 1, r)
...
<img src="http://i.imgur.com/CG6aftV.png" alt="" style="max-width: 700px; display: block; margin: 0 auto;" />
