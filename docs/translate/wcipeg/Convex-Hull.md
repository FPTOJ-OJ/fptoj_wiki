...
<img src="/uploads/algo_geometry_convex_hull_nail.png" alt="/uploads/algo_geometry_convex_hull_nail.png" style="max-width: 700px; display: block; margin: 0 auto;" />
...
**Chú ý 1:** Bạn đọc nên xem qua [Hình học tính toán phần 1](../../algo/geometry/basic-geometry-1.md) và [Hình học tính toán phần 2](../../algo/geometry/basic-geometry-2.md) trước khi tiếp tục để biết về các khái niệm cơ bản.
...
|<img src="/uploads/algo_geometry_convex_hull_gift_wrapping_algorithm.png" alt="/uploads/algo_geometry_convex_hull_gift_wrapping_algorithm.png" style="max-width: 700px; display: block; margin: 0 auto;" />
|
|-|
...
|<img src="https://upload.wikimedia.org/wikipedia/commons/9/9c/Animation_depicting_the_gift_wrapping_algorithm.gif" alt="" style="max-width: 700px; display: block; margin: 0 auto;" />
|
|-|
...
|<img src="/uploads/algo_geometry_convex_hull_graham_scan.gif" style="max-width: 700px; display: block; margin: 0 auto;" />|
|-|
...
|<img src="/uploads/algo_geometry_convex_hull_UpperAndLowerConvexHulls.png" alt="/uploads/algo_geometry_convex_hull_UpperAndLowerConvexHulls.png" style="max-width: 700px; display: block; margin: 0 auto;" />
|
|-|
...
|<img src="/uploads/algo_geometry_convex_hull_monotone_algorithm.gif" style="max-width: 700px; display: block; margin: 0 auto;" />|
|-|
...
## Bao lồi 3D
<img src="/uploads/algo_geometry_convex_hull_3d.gif" style="max-width: 700px; display: block; margin: 0 auto;" />
...
- Đầu tiên, ta kiểm tra $(H_0, H_1, P)$ có ngược chiều kim đồng hồ hay không ($P$ thoả thuộc vùng màu xanh).
    <img src="/uploads/algo_geometry_convex_hull_kmix1.png" alt="/uploads/algo_geometry_convex_hull_kmix1.png" style="max-width: 700px; display: block; margin: 0 auto;" />
- Tiếp theo, ta kiểm tra $(H_{n-1}, H_0, P)$ có ngược chiều kim đồng hồ hay không ($P$ thoả thuộc vùng màu cam).
    <img src="/uploads/algo_geometry_convex_hull_kmix2.png" alt="/uploads/algo_geometry_convex_hull_kmix2.png" style="max-width: 700px; display: block; margin: 0 auto;" />
...
- Sau khi có $x$ (ví dụ $x=4$), ta biết được rằng $P$ thuộc vùng tạo bởi $2$ tia $\overrightarrow{H_0H_{x-1}}$ và $\overrightarrow{H_0H_x}$ (vùng màu tím).
    <img src="/uploads/algo_geometry_convex_hull_kmix3.png" alt="/uploads/algo_geometry_convex_hull_kmix3.png" style="max-width: 700px; display: block; margin: 0 auto;" />
